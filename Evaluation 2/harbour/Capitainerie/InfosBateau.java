...
public class InfosBateau extends javax.swing.JFrame {
    ...
    public InfosBateau(ArrayList<BateauPlaisance> ListeBateauPlaisance, ArrayList<BateauPeche> ListeBateauPeche, ArrayList<Ponton> ListePonton, ArrayList<Quai> ListeQuai, int SelectedRow) {
        ...
        switch (PavillonBateau)
        {
            case "BE" :
                LabelPavillon.setIcon(new ImageIcon(getClass().getResource("/images/BE.jpg")));
                break;
            case "FR" :
                LabelPavillon.setIcon(new ImageIcon(getClass().getResource("/images/FR.jpg")));
                break;
            case "DE" :
                LabelPavillon.setIcon(new ImageIcon(getClass().getResource("/images/DE.jpg")));
                break;
            case "UK" :
    ...
    private void initComponents() {
        ...
        LabelInfosSupplementaires = new javax.swing.JTextField();
        ...
        LabelPavillon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/BE.jpg"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGap(150, 150, 150)
                        .addComponent(LabelInfosSupplementaires)))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addComponent(LabelPavillon, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(16, 16, 16)
                        .addComponent(jLabel6))
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(LabelInfosSupplementaires, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Labelinfos))
                .addGap(18, 18, 18)
    ...
    private void BoutonOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BoutonOkActionPerformed
        if (equipage.getNombreHumains() != 0)
        {
            try
            {
                ...
                Supplement = this.LabelInfosSupplementaires.getText();
                    ...
                    if ("Plaisance".equals(TypeBateau))
                    {
                        ...
                        else
                        {
                            ...
                            for (int j = 0; j < ListePonton.size(); j++)
                            {
                                ...
                                int k = 0;
                                ArrayList<MoyenDeTransportSurEau> listA = p.getListeBateauCote1();
                                ArrayList<MoyenDeTransportSurEau> listB = p.getListeBateauCote2();
                                for (int i=0; i < cap; i++)
                                {
                                    if (i < tempA)
                                    {
                ...
                if (TableBateaux.getRowCount() != 0)
                    Capitainerie.BoutonBateauAmarre.setEnabled(true);  
                else
                    Capitainerie.BoutonBateauAmarre.setEnabled(false);
    ...
    private javax.swing.JTextField LabelInfosSupplementaires;
